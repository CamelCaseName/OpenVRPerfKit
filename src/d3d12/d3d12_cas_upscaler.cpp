...
namespace vrperfkit {
	...
	D3D12CasUpscaler::D3D12CasUpscaler(ID3D12Device *device) {
		LOG_INFO << "Creating D3D12 resources for CAS upscaling...";
	...
	void D3D12CasUpscaler::Upscale(const D3D12PostProcessInput &input, const Viewport &outputViewport) {
